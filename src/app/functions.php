...
//checks if the number contains dutch area codes
    function isduchtphone()
    {   $test=mb_strcut($_POST['phone'],0,4);
...
//checks if all form contain information
function noentry()
{
...
//function to redirect a person to a different page
